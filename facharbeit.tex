...
There is an ongoing progress of defining free time in leisure studies. Several definitions of free time, leisure time and spare time has been defined in multiple ways \citep[p.14]{freysinger}. German leisure studies distinguish between ``positive''  and ``negative'' concepts of leisure (free time). 

Originated in the protestantic work ethic and industrialization, negative leisure (free time) describes the time off from non-eligible activities, including employment, transit time, hygiene and eating \citep[p.408]{Prahl2010}. Consequently an individual is required to be in employment in order to have the possibility of leisure (free time). \citeauthor{scheuch1972} overcomes this mayor weakness of the just mentioned definition and refocuses the decisive part of leisure (free time). \citeauthor{scheuch1972} suggests to replace the type of activity with the relation between the activity and the functional role of the individual. Leisure (free time) is not meant to be a quantitative time unit anymore, but rather defines itself as an own phenomenon \citep[p.31]{scheuch1972}. This opens up the second concept of leisure (free time).

Positive leisure (free time) focuses on the fact, that an activity ``has been chosen primarily for its own sake, for the experience itself'' \citep[p.15]{freysinger}. 

In the context of this thesis free time is meant to be the time away from non-eligible activities, as previously referenced as ``negative'' leisure (free time).
