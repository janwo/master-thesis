\documentclass[12pt,numbers=noenddot,parskip,bibliography=totocnumbered,listof=totocnumbered,draft=true]{scrreprt}
...
\begin{figure}
\centering
\subfloat[][]{\label{icons}\includegraphics[width=0.33\textwidth]{icons.png}}
\qquad\qquad
\subfloat[][]{\label{fonts}\includegraphics[width=0.33\textwidth]{fonts.png}}
\caption[Icons and typefaces]{Icons and typefaces as definied by the visual language: Multiple iterations of the logo \subref{icons} with different shapes and colors. The non-transparent icon is the final version of the logo. The typeface \subref{fonts} consits of two sans serif fonts - Quicksand is used for headings, whereas Lato is used for floating text.}
\end{figure}
...
\begin{figure}
\centering
\subfloat[][]{\label{searchrudel}\includegraphics[width=\linewidth]{searchrudel.png}}
\qquad
\subfloat[][]{\label{createrudel0}\includegraphics[width=\linewidth]{createrudel0.png}}

\subfloat[][]{\label{createrudel1}\includegraphics[width=\linewidth]{createrudel1.png}}
\qquad
\subfloat[][]{\label{rudel}\includegraphics[width=\linewidth]{rudel.png}}
\caption[Screenshots of the organisation of interest groups]{Icons and typefaces as definied by the visual language: Multiple iterations of the logo \subref{icons} with different shapes and colors. The non-transparent icon is the final version of the logo. The typeface \subref{fonts} consits of two sans serif fonts - Quicksand is used for headings, whereas Lato is used for floating text.}
\end{figure}
%
%\begin{figure}
%\begin{subfigure}{0.45\textwidth}
%\includegraphics[width=\linewidth]{searchrudel.png}
%\caption{Search for interest groups.}
%\label{searchrudel}
...
%\caption{Specify a name for the interest group.}
%\label{createrudel0}
%\end{subfigure}
%\begin{subfigure}{0.45\textwidth}
%\includegraphics[width=\linewidth]{createrudel1.png}
%\caption{Specify an icon for the interest group.}
%\label{createrudel1}
%\end{subfigure}
%\hfill
%\begin{subfigure}{0.45\textwidth}
%\includegraphics[width=\linewidth]{rudel.png}
%\caption{Organisation for panel for an interest group.}
%\label{rudel}
%\end{subfigure}
%\caption{}
%\end{figure}
