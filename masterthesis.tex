...
%The case study should get a general impression of the members opinion about the machine and the underlying idea as stated in the guideline (no self-promotion; no social feed or other features; instant messenging; recommendations => alogirhtm works, signifikanz für die interviewees bestätigt, all said it was rather accurate, almost all said it was rather helpful, ndt wäre likert scale besser gewesen um neutral ankreuzbar zu machen, reliability of recommendations made by the application=> Works, not patronized, suggestions can be made like thi; keep it simple => sus gut ausgefallen, auch bei vor und nachteilen wurde die usability und die übersichtlichkeit von 2/3 der befragten explizit gelobt, die hälfte der befragten gab an, dass es besonders einfach war streifzüge zu erstellen. Zwei Interviewees haben dies zudem explizit mit facebook verglichen und empfanden es als einfacher.). 
...
%Was hätte man verbessern können? auch wenn die case study nach besten gewissen gemäß geltender statistischer methoden nach vorheriger studium von literatur ausgeführt wurde, hätte im nachhinein folgendes getan werden können: likert scale, anzahl der interviewees, vor allem bei den statistisch erhobenen werten. Zudem wurde deutlich, wie schwierig es ist eine kritische masse für eine plattform zu gewinnen. Trotz der vielen anmeldungden, war verhätlnismäßg wenig los. Dies wurde auch von einem interviewee geannnt. 

\chapter{Conclusion}


%Thema, wie in der Einführung, aufgreifen
%Ausblick formulieren, future reasearch, auch im bezug auf interdisziplinärität, um tiefer in die bewegründe für das gefühl vpn pressed time einzutauchen
