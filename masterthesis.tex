...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{img/colors.png}
...
\includegraphics[width=\linewidth]{img/icons.png}
\caption{A selection of logos with different shapes and colors. The non-transparent icon is the final version of the logo.}
\label{icons}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
\includegraphics[width=\linewidth]{img/fonts.png}
\caption{The typeface consits of two sans serif fonts: Quicksand is used for headings, whereas Lato is used for floating text.}
\label{fonts}
\end{subfigure}
\caption[Icons and typefaces]{Icons and typefaces as definied by the visual language.}
\end{figure}
...
As the visual language can ensure a streamlined design of the application, the corresponding features are presented in the next section.
